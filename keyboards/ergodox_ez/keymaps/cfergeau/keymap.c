...
enum layers {
    ...
    SYMB,  // symbols
    MDIA,  // media keys
    NAVIM, // navigation/num layer
    FUNC,  // function key layer
};
...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_TAB,          KC_Q,        KC_W,          KC_E,    KC_R,    KC_T,    TT(SYMB),             TT(SYMB),     KC_Y,    KC_U,    KC_I,    KC_O,              KC_P,           KC_BSPC,
  //KC_BSPC,         KC_A,        KC_S,          KC_D,    KC_F,    KC_G,                                        KC_H,    KC_J,    KC_K,    KC_L,    LT(MDIA, KC_SCLN), GUI_T(KC_QUOT),
  KC_ESC,          LGUI_T(KC_A),LALT_T(KC_S),    LSFT_T(KC_D), LCTL_T(KC_F), KC_G,                              KC_H,LCTL_T(KC_J),RSFT_T(KC_K),LALT_T(KC_L),RGUI_T(KC_SCLN),KC_QUOT,
  //KC_LSFT,         CTL_T(KC_Z), KC_X,          KC_C,    KC_V,    KC_B,    ALL_T(KC_NO),                  MEH_T(KC_NO), KC_N,    KC_M,    KC_COMM, KC_DOT,           CTL_T(KC_SLSH), KC_RSFT,
  KC_LSFT,         LCTL_T(KC_Z),KC_X,          KC_C,    KC_V,    KC_B,    ALL_T(KC_NO),                  KC_RALT,      KC_N,    KC_M,    KC_COMM, KC_DOT,          LCTL_T(KC_SLSH), KC_ENT,
  //LT(SYMB,KC_GRV), KC_QUOT,     LALT(KC_LSFT), KC_LEFT, KC_RGHT,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, TT(SYMB),
  KC_LCTL,         KC_QUOT,     KC_LALT,       MO(4),   MO(3),                                              KC_RALT,   MO(3), KC_RALT, KC_RBRC, TT(SYMB),
  //                                                         ALT_T(KC_APP), KC_LGUI,                KC_LALT, CTL_T(KC_ESC),
                                                          LALT_T(KC_APP), KC_LGUI,                KC_LALT, LCTL_T(KC_ESC),
                                                                          KC_HOME,                 KC_PGUP,
...
[NAVIM] = LAYOUT_ergodox_pretty(
  KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO, KC_NO,         KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
  KC_GRV, KC_NO, KC_7,  KC_8,  KC_9,    KC_NO, KC_NO,         KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_DEL,  KC_NO,
  KC_NO,  KC_0,  KC_4,  KC_5,  KC_6,    KC_0,                        KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSPC, KC_NO,
  KC_NO,  KC_NO, KC_1,  KC_2,  KC_3,    KC_NO, KC_NO,         KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_DEL,  KC_NO,
  KC_NO,  KC_NO, KC_NO, KC_NO, KC_TRNS,                                       KC_NO,   KC_TRNS, KC_NO,   KC_NO,   KC_NO,
...
[FUNC] = LAYOUT_ergodox_pretty(
  KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO,   KC_NO,  KC_NO,       KC_NO, KC_NO,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  KC_NO, KC_1,  KC_2,  KC_3,    KC_4,    KC_5,   KC_NO,       KC_NO, KC_6,   KC_7,  KC_8,  KC_9,  KC_0,  KC_BSPC,
  KC_NO, KC_F1, KC_F2, KC_F3,   KC_F4,   KC_F5,                      KC_F6,  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  KC_NO, KC_F7, KC_F8, KC_F9,   KC_F10,  KC_F11, KC_NO,       KC_NO, KC_F12, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS,                                     KC_NO, KC_NO, KC_NO, KC_NO, KC_MPLY,
                                         KC_NO, KC_NO,        KC_NO, KC_NO,
                                                KC_NO,        KC_NO,
                                  KC_NO, KC_NO, KC_NO,        KC_NO, KC_NO, KC_NO
)
