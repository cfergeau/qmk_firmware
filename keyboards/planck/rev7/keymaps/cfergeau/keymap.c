...
enum planck_layers { _QWERTY, _COLEMAK, _DVORAK, _LOWER, _RAISE, _ACCENTS, _PLOVER, _ADJUST };

enum planck_keycodes { QWERTY = SAFE_RANGE, COLEMAK, DVORAK, PLOVER, EXT_PLV };
